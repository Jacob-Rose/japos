...
**JAPOS (Jakes Audio Project Organization System)** is an Electron-based desktop application for managing Ableton Live projects. It scans directories for `.als` files, extracts track information, and displays projects in a filterable grid interface.
